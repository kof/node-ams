...
exports.options = {
    ...
    // dataimg will not work if abspath was done before
    processorsOrder: [
        'jstransport', 'uglifyjs', 'cssmin', 'cssvendor', 'cssimport',
        'cssdataimg', 'cssabspath', 'htmlabspath', 'texttransport'
    ],
 ...
 * @param {targetDir=} path to target dir.
 * @this Build
 * @return {Build} this.
 */
proto.add = function(path, targetDir) {
    // path is relative
    if (path.substr(0, 1) !== '/') {
    ...
    this.data[n.path.join(targetDir, n.path.basename(path))] = n.fs.readFileSync(path);
    return this;
};
