...
/**
 * Resolve a path as require would do it.
 ...
 * @param {string} path to the file within the has been found.
 * @param {string} root directory relativ to which the url pathname shold be resolved.
